...
TRANSLATIONS: dict[str, dict[str, str]] = {
    'page_title': {'en': 'Multi-Floor Mapping', 'zh': '多层建图'},
    ...
    'path_prior': {'en': 'PGO prior', 'zh': 'PGO 定位先验'},
    'path_bag': {'en': 'Diagnostic ROS bag', 'zh': '诊断 ROS bag'},
    'path_grid_map': {'en': 'GridMapper output', 'zh': 'GridMapper 输出'},
    'path_nav_maps': {'en': 'Navigation map project', 'zh': '导航地图项目'},
    'abort_mapping': {'en': 'Terminate and Stop All Nodes', 'zh': '终止流程并关闭所有节点'},
    ...
    'step0_name': {'en': 'Project Management', 'zh': '项目管理'},
    ...
    's0_header': {'en': 'Project Management', 'zh': '项目管理'},
    ...
    'project_inventory_header': {'en': 'Project Inventory', 'zh': '项目清单'},
    'project_inventory_empty': {'en': 'No mapping projects have been found yet.', 'zh': '暂未发现建图项目。'},
    'project_column_name': {'en': 'Project', 'zh': '项目名称'},
    'project_column_status': {'en': 'Status', 'zh': '当前状态'},
    'project_column_source': {'en': 'Stored In', 'zh': '存储来源'},
    'project_column_maps': {'en': 'Floor Maps', 'zh': '楼层地图'},
    'project_source_navigation_and_prior': {'en': 'Navigation project + PGO prior', 'zh': '导航项目 + PGO 定位先验'},
    'project_source_navigation_project': {'en': 'Navigation project', 'zh': '导航项目'},
    'project_source_pgo_prior': {'en': 'PGO prior', 'zh': 'PGO 定位先验'},
    'project_status_completed': {'en': 'Completed and deployed', 'zh': '已完成并部署'},
    'project_status_ready_for_second': {'en': 'Pass 1 approved; ready for Pass 2', 'zh': '第一圈已确认，可继续第二圈'},
    'project_status_first_loop_only': {'en': 'First-loop prior only', 'zh': '仅完成第一圈先验'},
    'project_status_incomplete': {'en': 'Incomplete project data', 'zh': '项目数据不完整'},
    'new_project_header': {'en': 'Create a New Mapping Project', 'zh': '新建建图项目'},
    'start_workflow': {'en': 'Start New Mapping', 'zh': '开始新建图'},
    ...
    's1_start_system': {'en': 'Start Lidar and IMU Bridge', 'zh': '启动雷达与 IMU 桥接'},
    's1_lidar_input': {'en': 'Lidar input', 'zh': '雷达输入'},
    's1_imu_input': {'en': 'IMU input', 'zh': 'IMU 输入'},
    's1_wait_sensor_inputs': {'en': 'Waiting for both sensor inputs... ({elapsed:.0f}s)',
                              'zh': '正在等待两路传感器输入…（{elapsed:.0f}s）'},
    ...
    'log': {'en': 'Log', 'zh': '日志'},
    'no_active': {'en': 'No running background sessions', 'zh': '无运行中的后台会话'},
    'messages': {'en': 'Runtime Messages', 'zh': '运行消息'},
    ...
    'msg_livox_ready': {'en': 'Lidar input is ready: {hz:.1f} Hz', 'zh': '雷达输入已就绪：{hz:.1f} Hz'},
    'msg_imu_ready': {'en': 'IMU input is ready: {hz:.1f} Hz', 'zh': 'IMU 输入已就绪：{hz:.1f} Hz'},
    'msg_sensor_system_ready': {'en': 'Lidar and IMU inputs are ready.', 'zh': '雷达与 IMU 输入均已就绪。'},
    'msg_release_done': {'en': 'Control released: {output}', 'zh': '控制权已释放：{output}'},
    'msg_start_slam': {'en': 'Starting PGO SLAM...', 'zh': '正在启动 PGO SLAM...'},
    ...
    'msg_start_grid': {'en': 'Starting GridMapper...', 'zh': '正在启动 GridMapper...'},
    ...
    's3_cloud_input': {'en': 'Registered cloud', 'zh': '配准点云'},
    's3_odometry_input': {'en': 'Relocalized odometry', 'zh': '重定位里程计'},
    's3_multimap_header': {'en': 'Multi-floor Map Switching', 'zh': '多层地图切换'},
    ...
    'two_loop_first_sensors_desc': {'en': 'Start the lidar and IMU bridge together, then release platform control. These nodes '
                                    'remain active throughout both mapping passes and are stopped only after the '
                                    'final map review.',
                                    'zh': '同时启动激光雷达与 IMU 桥接后释放底盘控制权。它们将在两圈建图期间持续运行，直至最终地图审核完成后统一关闭。'},
